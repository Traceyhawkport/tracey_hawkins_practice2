...
import Classpractice.Person1;

public class Main {
    public static void main(String[] args) {

        StudentRecord1 student1 = new StudentRecord1("Tracey", 3.0,3.9);
        StudentRecord1 student2 =new StudentRecord1("Leo",4.0, 4.0);
        StudentRecord1 student3 =new StudentRecord1("Mickey",3.6, 4.0);
